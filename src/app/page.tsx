      ...
      <header className="sticky top-0 z-50 border-b border-[#d4c2c8] bg-[#fcf9f8]/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-6 py-4">
          <div className="flex items-center justify-between gap-6">
            <Link
              href="/"
              className="text-2xl font-bold tracking-[0.2em] text-[#431830]"
            >
              PARZIO
            </Link>
            ...
            <Link
              href="/search"
              className="relative hidden flex-1 rounded-lg border border-[#d4c2c8] bg-white py-3 pl-11 pr-4 text-sm text-[#5f5e5d] md:block"
            >
              <span className="absolute left-4 top-1/2 -translate-y-1/2">
                🔍
              </span>
              Search for products, brands, or concerns...
            </Link>
          ...
          <nav className="mt-4 hidden justify-center gap-8 text-xs font-bold uppercase tracking-wider text-[#504348] md:flex">
            ...
            <Link href="/products">Makeup</Link>
            <Link href="/products">Fragrance</Link>
            <Link href="/products">Haircare</Link>
            <Link href="/products">Bath &amp; Body</Link>
            <Link href="/products">Wellness</Link>
          </nav>
        </div>
      </header>
        ...
        <section className="mx-auto max-w-7xl px-6 py-6">
          <div className="relative flex min-h-[500px] items-center overflow-hidden rounded-lg">
            ...
            <div className="relative z-10 max-w-xl p-8 md:p-12">
              ...
              <Link
                href="/offers"
                className="inline-flex rounded bg-[#5d2e46] px-6 py-3 text-sm font-bold uppercase tracking-wider text-white transition hover:bg-[#431830]"
              >
                Shop the Sale →
              </Link>
            </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-[#504348]">
              ...
              <Link href="/help">Store Locator</Link>
